...
//const API_DOMAIN = 'http://127.0.0.1:8080/wechat-process/?service=';
const API_DOMAIN = 'https://127.0.0.1:8080/wechat-process/';
...
function nab_schedule(params) {
  return fetchApi('managerUser/listPageManagerUser.do', params).then(res => res);
}
// 直播室信息
